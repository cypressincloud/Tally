...
// 【修改】版本号升级为 5
@Database(entities = {Transaction.class, AssetAccount.class}, version = 5, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    // 【新增】版本 4 -> 5 迁移策略：Transaction 表增加 assetId 字段
            ...
            synchronized (AppDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            ...
                            .addMigrations(MIGRATION_2_3, MIGRATION_3_4, MIGRATION_4_5) // 添加新迁移
